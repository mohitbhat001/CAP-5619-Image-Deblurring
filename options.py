...
parser.add_argument("--wblogger",type=str,default="DeBlurModel",help = "Determine to log to wandb or not and the project name")
parser.add_argument("--ckpt_dir",type=str,default="DeBlurModel",help = "Name of the Directory where the checkpoint is to be saved")
